...
if __name__ == "__main__":
    ...
    factory = CSVFactory(N = N, M = M, c = c, r = r, G = G, B = B, gamma = gamma, beta = beta, sigma = sigma, mu = mu, s = s, alpha = alpha, compulsory = compulsory, SOP = SOP)
